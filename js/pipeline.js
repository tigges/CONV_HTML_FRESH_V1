// ══════════════════════════════════════════════════════════════════
// Flowchart Converter v4.0 — pipeline.js — repairMermaid, sanitiseLabels, injectColours, Clean, Chunk, Pre-Parse, Analyse stages
...
function exportPreParsePrint() {
  ...
  var html = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8">' +
    ...
    '<div class="sub">Document: <strong>' + escHtml(docTitle) + '</strong> &nbsp;·&nbsp; ' + dateStr + ' &nbsp;·&nbsp; ' + pipe.preparsed.length + ' items &nbsp;·&nbsp; Flowchart Converter ' + APP_VERSION + '</div>' +
    ...
    '<div style="margin-top:20px;font-size:11px;color:#9ca3af;">Generated by Flowchart Converter — print this sheet and compare against your original document. Mark corrections then apply interactively in the Pre-Parse pane.</div>' +
    '</body></html>';
